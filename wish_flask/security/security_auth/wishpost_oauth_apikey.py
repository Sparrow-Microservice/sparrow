from wish_flask.security.security import APIKey
from wish_flask.micro_clients.wishpost_oauth import auth_api
...
from wish_flask.schema.user import UserSchema
...
class WishpostOauthAPIKey(APIKey):
    ...
    def _cache_get_session_pack_response(self):
        ...
        cache_manager_wishpost_oauth = import_string(
            'wish_flask.extensions.cache_manager.instance.cache_manager_' + cache_manager)

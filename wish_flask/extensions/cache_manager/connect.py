from wish_flask.extensions.cache_manager.instance import _instance_manager
from wish_flask.extensions.redis.instance import \
...
from wish_flask.extensions.cache_manager.strict_redis_cache_cli import \
    StrictRedisCache
